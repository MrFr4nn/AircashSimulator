...
namespace Services.AircashPaymentAndPayout
{
    ...
    {
        Task<object> CheckCode(string barCode, string locationID, Guid partnerId, Guid userId);
        Task<object> ConfirmTransaction(string barCode, string locationID, Guid partnerId, Guid userId);
        Task<object> CheckTransactionStatus(string partnerTransactionID, Guid partnerId, Guid userId);
