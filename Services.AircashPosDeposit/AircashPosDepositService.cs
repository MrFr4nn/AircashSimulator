...
namespace Services.AircashPosDeposit
{
    ...
    public class AircashPosDepositService : IAircashPosDepositService
    {
        ...
        public AircashPosDepositService(AircashSimulatorContext aircashSimulatorContext, IHttpRequestService httpRequestService, ISignatureService signatureService)
        {
