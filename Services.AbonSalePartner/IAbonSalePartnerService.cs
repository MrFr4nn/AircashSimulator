...
namespace Services.AbonSalePartner
{
    public interface IAbonSalePartnerService
    {
        ...
        Task<string> CreateMultipleCouponCashier(decimal value, string pointOfSaleId, Guid partnerId, string isoCurrencySymbol, Guid partnerTransactionId, string privateKeyPath, string privateKeyPass, EnvironmentEnum environment);
    }
}
