    ...
    ['$scope', '$location', '$state', '$filter', 'HelperService', 'acFrameV2PayService', '$http', 'JwtParser', '$uibModal', '$rootScope', '$window', '$localStorage', 'config',
        function ($scope, $location, $state, $filter, HelperService, acFrameV2PayService, $http, JwtParser, $uibModal, $rootScope, $window, $localStorage, config) {
            ...
            $scope.initiateRedirectCheckout = function () {
                ...
                $scope.initiateModel.locale = $scope.locale.languageInput.toLowerCase() + "-" + $scope.locale.countryISOCodeInput.toUpperCase();
                acFrameV2PayService.initiateRedirectCheckout($scope.initiateModel, matchParameters)
            ...
            $scope.initiateSimulateError = (errCode) => {
                ...
                acFrameV2PayService.initiateSimulateError(errCode)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatus = function () {
                ...
                $scope.statusResponded = false;
                acFrameV2PayService.transactionStatus($scope.transactionModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlTransactionStatus = function () {
                ...
                $scope.curlStatusResponded = false;
                acFrameV2PayService.getCurlTransactionStatus($scope.transactionModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusV2 = function () {
                ...
                acFrameV2PayService.transactionStatusV2($scope.transactionModelV2)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlTransactionStatusV2 = function () {
                ...
                $scope.curlStatusV2Responded = false;
                acFrameV2PayService.getCurlTransactionStatusV2($scope.transactionModelV2)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusV3 = function () {
                ...
                acFrameV2PayService.transactionStatusV3($scope.transactionModelV3)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlTransactionStatusV3 = function () {
                ...
                $scope.curlStatusV3Responded = false;
                acFrameV2PayService.getCurlTransactionStatusV3($scope.transactionModelV3)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusSimulateError = (errCode) => {
                ...
                acFrameV2PayService.transactionStatusSimulateError(errCode)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusV2SimulateError = (errCode) => {
                ...
                acFrameV2PayService.transactionStatusV2SimulateError(errCode)
                    .then(function (response) {
                        if (response) {
