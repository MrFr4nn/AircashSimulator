...
app.config(function ($stateProvider, Global) {
    $stateProvider
        .state('app.acFrameV2Withdrawal', {
            ...
            controller: 'acFrameV2WithdrawalCtrl',
    ...
    ['$scope', '$location', '$state', '$filter', 'HelperService', 'acFrameV2WithdrawalService', '$http', 'JwtParser', '$uibModal', '$rootScope', '$window', '$localStorage', 'config',
        function ($scope, $location, $state, $filter, HelperService, acFrameV2WithdrawalService, $http, JwtParser, $uibModal, $rootScope, $window, $localStorage, config)
        {
            ...
            $scope.initiateRedirectCheckout = function () {
                ...
                $scope.initiateModel.locale = $scope.locale.languageInput.toLowerCase() + "-" + $scope.locale.countryISOCodeInput.toUpperCase();
                acFrameV2WithdrawalService.initiateRedirectCheckout($scope.initiateModel, matchParameters)
            ...
            $scope.initiateSimulateError = (errCode) => {
                ...
                acFrameV2WithdrawalService.initiateSimulateError(errCode)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatus = function () {
                ...
                $scope.statusResponded = false;
                acFrameV2WithdrawalService.transactionStatus($scope.transactionModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlTransactionStatus = function () {
                ...
                $scope.curlStatusResponded = false;
                acFrameV2WithdrawalService.getCurlTransactionStatus($scope.transactionModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusV2 = function () {
                ...
                acFrameV2WithdrawalService.transactionStatusV2($scope.transactionModelV2)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlTransactionStatusV2 = function () {
                ...
                $scope.curlStatusV2Responded = false;
                acFrameV2WithdrawalService.getCurlTransactionStatusV2($scope.transactionModelV2)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusV3 = function () {
                ...
                acFrameV2WithdrawalService.transactionStatusV3($scope.transactionModelV3)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlTransactionStatusV3 = function () {
                ...
                $scope.curlStatusV3Responded = false;
                acFrameV2WithdrawalService.getCurlTransactionStatusV3($scope.transactionModelV3)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusSimulateError = (errCode) => {
                ...
                acFrameV2WithdrawalService.transactionStatusSimulateError(errCode)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.transactionStatusV2SimulateError = (errCode) => {
                ...
                acFrameV2WithdrawalService.transactionStatusV2SimulateError(errCode)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.confirmPayout = function () {
                ...
                $scope.confirmResponded = false;
                acFrameV2WithdrawalService.confirmPayout($scope.confirmModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlConfirmPayout = function () {
                ...
                $scope.curlConfirmResponded = false;
                acFrameV2WithdrawalService.getCurlConfirmPayout($scope.confirmModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.confirmSimulateError = (errCode) => {
                ...
                acFrameV2WithdrawalService.confirmSimulateError(errCode)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.cancelPayout = function () {
                ...
                $scope.cancelResponded = false;
                acFrameV2WithdrawalService.cancelPayout($scope.cancelModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.getCurlCancelPayout = function () {
                ...
                $scope.curlCancelResponded = false;
                acFrameV2WithdrawalService.getCurlCancelPayout($scope.cancelModel)
                    .then(function (response) {
                        if (response) {
            ...
            $scope.cancelPayoutSimulateError = (errCode) => {
                ...
                acFrameV2WithdrawalService.cancelPayoutSimulateError(errCode)
                    .then(function (response) {
                        if (response) {
